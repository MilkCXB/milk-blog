    ...
    <div class="bar" v-show="show">
      <div style="margin-top: -50px">
        ...
        <ul class="flex-center-center bar-nav">
          <li class="bar-nav-item" @click="goToClassify('Mood')">个人心情</li>
          <li class="bar-nav-item" @click="goToClassify('Study')">学习笔记</li>
          <li class="bar-nav-item" @click="goToClassify('Music')">音乐心得</li>
          <li class="bar-nav-item" @click="goToClassify('Game')">游戏盘点</li>
        </ul>
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const goToClassify = (style: string) => {
